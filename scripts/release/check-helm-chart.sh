...
require_pattern scripts/k8s/deploy-production.sh 'kind-start' 'existing kind cluster start action'
require_pattern scripts/k8s/deploy-production.sh 'kind-stop' 'existing kind cluster stop action'
require_pattern scripts/k8s/deploy-production.sh 'kind cluster .* does not exist; run make kind-production-deploy first' 'missing kind cluster guidance'
require_pattern scripts/k8s/deploy-production.sh '--kube-context' 'explicit kind Helm context selection'
